...
How do we insert elements, find elements, or remove elements in a MWT? The algorithm for them are essentially the same. For this, we are going to do the following: 
\begin{itemize}
    \item Initialize MWT. 
    \item Insert ANT. 
    \item Insert ART. 
    ...
    \item Find ANT. 
\end{itemize}
Generally speaking, insertion works like so: 
\begin{itemize}
    \item Start at the root.
    ...
    \begin{itemize}
        ...
        \item Traverse down to that next child edge. 
    \end{itemize}
    \item Once we finish that word, we mark the current node as a word node. 
\end{itemize}

\begin{itemize}
    \item Initialize MWT: An initialized MWT is simply the root node. 
    \begin{verbatim}
        [ ]
    \end{verbatim}

    \item Insert ANT: We use the process defined above. 
    \begin{itemize}
        \item Insert A since it doesn't already exist. Then, traverse down. 
        \begin{verbatim}
            [ ]
             | 
             | A 
        ...
        \item Insert N since it doesn't already exist. Then, traverse down. 
        \begin{verbatim}
            [ ]
             | 
             | A 
        ...
        \item Insert T since it doesn't alredy exist. Then, traverse down. 
        \begin{verbatim}
            [ ]
             | 
             | A 
        ...
        \item Since we're done with all letters, set the node that we stopped at as a word node. 
        \begin{verbatim}
            [ ]
             | 
             | A 
    ...
    \item Insert ART: Same ideas as above. 
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
